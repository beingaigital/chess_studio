...
All notable changes to Chess Studio will be documented in this file.
...
- Rebranded the agent experience as Chess Studio with围棋导向的界面、复制品与社区定位
- Stockfish AI 难度选择器（5 档 Skill Level，自动保存偏好）
- 快捷悔棋与时间轴复盘功能，便于教学与自我回顾

### Changed

- README、LICENSE 引用、设计文档等更新为 Chess Studio 叙述
- 统一发行说明与发布流程，增加 Chess Studio 1.0 打包指引

### Removed

- 删除遗留的个人 PGN 记录等发布版本无关文件
