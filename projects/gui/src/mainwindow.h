...
class MainWindow : public QMainWindow
{
	...
	private:
		...
		void undoLastMove();
		bool canUndoCurrentGame() const;
		PlayerBuilder* createBuilderFromSetup(const PlayerSetup& setup) const;
		void startGameReplacement(TabData& tab, int index, ChessGame* newGame, const GameSetup& setup);
		void promptSaveGameToDatabase(ChessGame* game);
		bool appendGameToDatabase(const PgnGame* pgn);
		...
		QHash<ChessGame*, PendingGame> m_pendingGames;
		QSet<ChessGame*> m_gamesPendingReplacement;
